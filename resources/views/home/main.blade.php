...
<head>
    <meta charset="utf-8">
    <title>{{config('app.name')}}| Laundry Services</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta name="description" content="EasyWash Laundromat | We have redefined your laundry experience to make your least favorite chore more likable.">
    <meta name="keywords" content="Wash, easywash, Laundry Service, Laundry, Best Laundry Services, EasyWashLaundromat, Easy Wash Laundromat, Tshs 4000, Tanzania Dry Cleaners, Dar es Salaam Dry Cleaners, Dry Cleaner in Tanzania, Dry Cleaner in Dar es Salaam">
    <!-- Favicon -->
    ...
    <div class="container-lg position-relative p-0 px-lg-3" style="z-index: 9;">
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 pl-3 pl-lg-5">
            <a href="{{route('home')}}" class="navbar-brand">
                <img src="{{asset('assets/images/easywash_web_logo.jpeg')}}" alt="EasyWash Logo"  />
            </a>
...
<div class="container-fluid bg-primary text-white mt-5 pt-5 px-sm-3 px-md-5">
    <div class="row pt-5">
        <div class="col-lg-4 col-md-6 mb-5">
            <a href="{{route('home')}}" class="navbar-brand">
                <img src="{{asset('assets/images/easywash_logo.jpeg')}}" alt="Easy Wash" style="width: 141px; height: 126px" />
            </a>
